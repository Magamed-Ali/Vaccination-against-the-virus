            ...
            <div className="container  feedback-loop">
                <div className="row justify-content-center">
                    <div className="col-lg-4 col-md-6 col-sm-12 feedback-loop__case">
                        <div className="feedback-loop__case-info">
                            <div className="info-icon"><FontAwesomeIcon icon={faHospitalAlt}/></div>
                            <div>
                                <h5>Our Address</h5>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 feedback-loop__case">
                        <div className="feedback-loop__case-info">
                            <div className="info-icon"><FontAwesomeIcon icon={faPhoneAlt}/></div>
                            <div>
                                <h5>Our Phone</h5>
